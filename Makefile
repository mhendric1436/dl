...
GENERATED_TABLE_HEADERS := src/tables/generated/lease_row.hpp
...
codegen-check:
	...
	$(PYTHON) $(MT_CODEGEN) src/tables/schemas/lease.mt.json -o $(CODEGEN_CHECK_DIR)/lease_row.hpp
	$(FORMAT) -i $(CODEGEN_CHECK_DIR)/lease_row.hpp
	diff -u src/tables/generated/lease_row.hpp $(CODEGEN_CHECK_DIR)/lease_row.hpp
...
src/tables/generated/lease_row.hpp: src/tables/schemas/lease.mt.json
	$(PYTHON) $(MT_CODEGEN) $< -o $@
	$(FORMAT) -i $@
